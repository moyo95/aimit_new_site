...
export default function Recruit() {
  ...
  return (
    ...
    <Heros
      ...
      />
    <section id="contact" className="py-10 md:py-20 bg-gray-50 md:min-h-screen flex items-center">
      <div className="container mx-auto px-4 my-10 md:my-20">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">アルバイト・パート大募集！</h2>
