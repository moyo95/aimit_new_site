...
type fromContactProps = {
  ...
  return (
    <>
    <section id="contact" className={`py-6 md:py-20 bg-blue-50 ${className}`}>
      <div className="container mx-auto px-4  md:my-20">
        <div className="text-center my-8 md:mb-20">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">エントリーフォーム</h2>
