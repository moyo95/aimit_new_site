...
import { Droplet, Thermometer, Smile, Wrench, Shield, Clock, ShieldQuestion, ShoppingBag } from "lucide-react";
    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-4">給湯器/ガス給湯器の販売/取付工事を行っている、アイミット(株)です</h2>
